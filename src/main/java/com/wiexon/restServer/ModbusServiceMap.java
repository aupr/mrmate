            ...
            while (res.next()) {
                ...
                if (res.getString("modeView").equals("Enabled")){
                    try {
                        ...
                        LogTable.getDataList().add(new LogTableData("SL "+(i+1)+" is trying to connect!"));
                        ...
                        LogTable.getDataList().add(new LogTableData("SL "+(i+1)+" has connected!"));
                    } catch (Exception e) {
                        ServiceTable.getDataList().get(i).setStatus("Error");
                        LogTable.getDataList().add(new LogTableData("SL "+(i+1)+" got an error! The communication port may not be available!"));
                        e.printStackTrace();
                    }
                }
            }
            ...
            if (res.next()) {
                if (res.getString("modeView").equals("Enabled")){
                    try {
                        ...
                        LogTable.getDataList().add(new LogTableData("SL "+(trackTableRow.get(uri)+1)+" is trying to connect!"));
                        if (res.getString("connectionType").equals("Modbus TCP/IP")){
                        ...
                        LogTable.getDataList().add(new LogTableData("SL "+(trackTableRow.get(uri)+1)+" has connected!"));
                    } catch (Exception e) {
                        ServiceTable.getDataList().get(trackTableRow.get(uri)).setStatus("Error");
                        LogTable.getDataList().add(new LogTableData("SL "+(trackTableRow.get(uri)+1)+" got an error! The communication port may not be available!"));
                        e.printStackTrace();
                    }
